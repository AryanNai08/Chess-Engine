...
public class King extends Piece{
    ...
    public boolean isValidMovement(int col,int row){
        return Math.abs((col-this.col) * (row-this.row)) ==1 || Math.abs(col-this.col) + Math.abs(row-this.row) ==1 || canCastel(col,row);
    }

    private boolean canCastel(int col,int row){
            ...
            if(col ==6){
                ...
                if(rook !=null && rook.isFirstMove && isFirstMove){
                  return    board.getPiece(5,row)== null &&
                            ...
                            !board.checkSacnner.isKingChecked(new Move(board,this,5,row));
                }
            } else if (col==2) {
                    ...
                    if(rook !=null && rook.isFirstMove && isFirstMove){
                        return  board.getPiece(3,row)== null &&
                                ...
                                !board.checkSacnner.isKingChecked(new Move(board,this,3,row));
                    }
                }
            }
